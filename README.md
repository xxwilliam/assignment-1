...
Relay circuit: An electronic control device integration with a GPS tracker to communicate with the vehicle’s engine. 
 a power converter, it will also be connected devices via cloud IoT.</p>
...
between 25 to 40 weeks or longer. Experience in cloud computering and software engineering.</p>
...
![tests 4](https://user-images.githubusercontent.com/89674523/134449261-48bf203b-a3ee-4161-9484-acdaaddd1d02.jpg)
 ...
 <h4>Personality test report</h4>
 
 <p>I agree with the test resualts in that, i do like to work alone sometimes but i can work with others, if they need me.Idon't try and read to much into these kind of test resualts.</p>  
